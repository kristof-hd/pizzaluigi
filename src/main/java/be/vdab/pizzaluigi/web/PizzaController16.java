...
@Controller
@RequestMapping("pizzas16")
class PizzaController16 {
	private static final String PIZZAS_VIEW = "pizzas16";
	private static final String PRIJZEN_VIEW = "prijzen";
	private static final String PIZZA_VIEW = "pizza16";
	private static final String VAN_TOT_PRIJS_VIEW = "vantotprijs";
	private static final String TOEVOEGEN_VIEW = "toevoegen";
	private static final String REDIRECT_URL_NA_TOEVOEGEN = "redirect:/pizzas16";
	private final EuroService2 euroService;
	private final PizzaService pizzaService;

	PizzaController16(EuroService2 euroService, PizzaService pizzaService) {
