...
@Controller
@RequestMapping("pizzas10")

class PizzaController10 {
		
		private static final String PIZZAS_VIEW="pizzas10";
		private static final String PIZZA_VIEW="pizza10"; 
		...
		PizzaController10(EuroService2 euroService) {
